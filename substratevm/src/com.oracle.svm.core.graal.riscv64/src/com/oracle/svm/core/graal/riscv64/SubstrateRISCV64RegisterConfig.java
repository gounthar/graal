...
public class SubstrateRISCV64RegisterConfig implements SubstrateRegisterConfig {
    ...
    public CallingConvention getCallingConvention(Type t, JavaType returnType, JavaType[] parameterTypes, ValueKindFactory<?> valueKindFactory) {
        ...
        if (type.usesReturnBuffer()) {
             ...
             * for saving. This argument is not actually used by the function. We use x5 (t0) as a
             * scratch register to absorb this hidden argument, analogous to AArch64's r8.
             */
            ...
            locations[0] = x5.asValue(paramValueKind);
        }
